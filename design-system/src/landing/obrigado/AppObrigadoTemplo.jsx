...
/**
 * Página de obrigado do Plano Templo — confirmação de compra + os dois
 * passos de onboarding (app do Circle e espaço Primeiros Passos).
 * Copy em ./data.js. Renderizada com o design system Anju Mace.
 */
export function AppObrigadoTemplo() {
  useEffect(() => {
    document.title = 'Anju Mace · Bem-vinda ao Plano Templo'
  }, [])
