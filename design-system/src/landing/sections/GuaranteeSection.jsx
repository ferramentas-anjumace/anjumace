...
export function GuaranteeSection() {
  return (
    <Section id="garantia" tone="base" padding="md">
      <Reveal variant="scale" className="mx-auto flex max-w-3xl flex-col items-center gap-6 rounded-3xl border border-accent/30 bg-accent-subtle px-8 py-14 text-center md:px-16">
