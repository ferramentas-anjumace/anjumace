...
export function LoginPage() {
  ...
  return (
    <div className="grid min-h-screen place-items-center bg-ink-deep px-4 py-8 text-fg">
      <div className="relative w-full max-w-4xl overflow-hidden rounded-2xl border border-line bg-slate-900 shadow-e3">
        <div className="grid md:min-h-[560px] md:grid-cols-2">
          {/* ---------------------------------------------------- formulário */}
          <div className="flex flex-col justify-center gap-7 p-8 sm:p-12">
            <img src="/anju-mace-logo.svg" alt="Anju Mace" className="h-5 w-auto self-start" />

            <div>
              <h1 className="font-display text-display-l font-semibold leading-tight text-strong">Entrar</h1>
              <p className="mt-1.5 text-body-s text-muted">Acesse o console da equipe.</p>
            </div>

            {!isSupabaseConfigured && (
              <div className="flex items-start gap-2.5 rounded-lg border border-warn/40 bg-warn-tint p-3 text-body-s">
          ...
          {/* ------------------------------------------------- painel visual */}
          <div className="relative hidden overflow-hidden bg-sand-deep md:block" aria-hidden>
            <img
              src="/foto-home.webp"
              alt=""
